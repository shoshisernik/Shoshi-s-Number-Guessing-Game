#This version of the game includes all of the previous features, including the addition of the 'e' command, which allows the player to export the secret number as a separate file.
